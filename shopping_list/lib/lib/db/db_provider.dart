...
class DBProvider {
  ...
  var todos = [
    Todo("Carrot", parent: '1',),
    Todo("Potato", parent: '1',),
    Todo("Pumpkin", parent: '1', isCompleted: 1),
    Todo("Biscuits", parent: '2',),
    Todo("Chocolates", parent: '2',),
    Todo("Tea Bags", parent: '2',),
  ];

  var tasks = [
    Task('Shopping', id: '1',  color: Colors.purple.value, codePoint: Icons.shopping_cart.codePoint),
    Task('Market', id: '2', color: Colors.pink.value, codePoint: Icons.shopping_cart.codePoint),
  ];
